...
const InputStepList = ({ inputText, button }) => {
    ...
    return (
        <div className='rowEnd'>
            ...
            {nowSteps !== 3 ?
                <InputNameListValue arrowRotare={arrowRotare} arrowValueList={arrowValueList} hiddenListFormStepHandle={hiddenListFormStepHandle} /> : <InputNameListValue arrowRotare={arrowRotare} arrowValueList={arrowValueList} hiddenListFormStepHandle={hiddenListFormStepHandle}/>}
        </div>
    )
}
