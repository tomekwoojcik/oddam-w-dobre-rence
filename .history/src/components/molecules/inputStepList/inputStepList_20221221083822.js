...
const InputStepList = () => {
  ...
  return (
        <div className='rowEnd'>
            ...
            {!arrowRotare && (<div className='inputNameListValue'>{arrowValueList.map((el) => { return < ButtonCount key={el} el={el} hiddenListFormStepHandle={hiddenListFormStepHandle} /> })}</div>}
        </div>
  )
}
