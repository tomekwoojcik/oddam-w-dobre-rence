  ...
  return (
        <div className='itemsToDonateForm'>
            ...
            <div className='rowButton'>
              ...
              {nowSteps > 5 ? <button onClick={() => { formStepsIncrement(nowSteps) }} className='itemsToDonateFormButton'>Dalej</button> : <button onClick={{ }} className='itemsToDonateFormButton formButtonCheck'>Potwierdzam</button>}
            </div>
        </div>
  )
}
