    ...
    <div className='formStepOne'>
      ...
      <div className='inFormBox'>
        <label htmlFor='reusableClothes' className='inputName'>
          <input className='checkInput' id='reusableClothes' type={'checkbox'} value={'ubrania, które nadają się do ponownego użycia'} checked={isChecked} onChange={(e) => { handleCheck(e.target.value, e.target.checked) }} /><span className='checkBox'></span>
