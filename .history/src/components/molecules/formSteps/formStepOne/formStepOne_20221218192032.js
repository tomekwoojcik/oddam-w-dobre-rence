  ...
  return (
        <div className='formStepOne'>
            ...
            <div className='inFormBox'>
                <label htmlFor='reusableClothes' className='checkBoxName'><input className='checkInput' id='reusableClothes' type={'checkbox'} />ubrania, które nadają się do ponownego użycia</label>
