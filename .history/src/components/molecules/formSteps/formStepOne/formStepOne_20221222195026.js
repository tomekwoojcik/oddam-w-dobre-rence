    ...
    <div className='formStepOne'>
      ...
      <div className='inFormBox'>
        <label htmlFor='reusableClothes' className='inputName'>
          <input className='checkInput' id='reusableClothes' type={'checkbox'} value={'ubrania, które nadają się do ponownego użycia'} onClick={(e) => { handleCheck(e.target.value) }} /><span className='checkBox'></span>
