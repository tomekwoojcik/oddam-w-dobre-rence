        ...
        <div className='youGiveBackColumn'>
          ...
          <div className='infoDiv'>
            <div className='infoDivRow'>
              <p>Ulica</p> <span>{dataForm.clientAdress}</span>
            </div>
            <div className='infoDivRow'>
              <p>Miasto</p> <span>{dataForm.clientCity}</span>
            </div>
            <div className='infoDivRow'>
              <p>Kod pocztowy</p> <span>{dataForm.clientPostNumber}</span>
            </div>
            <div className='infoDivRow'>
              <p>Numer telefonu</p> <span>{dataForm.clientPhoneNumber}</span>
            </div>
          </div>
        </div>
        <div className='youGiveBackColumn'>
