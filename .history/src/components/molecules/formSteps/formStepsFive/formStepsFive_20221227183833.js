    ...
    <div className='formStepOne infoSteps'>
      ...
      <div className='youGiveBack'>
        ...
        <div className='youGiveBackRow'>
          ...
          <p className='paragrafClothes'>{dataForm.enterTheNumberOfBags} worki,  ubrania {dataForm.selectWhatYouWantToGiveBack.map((el) => (<span key={el}>{el}, </span>))} {dataForm.whoDoYouWantToHelp.map((el) => (<span key={el}>{el}, </span>))}</p>
        </div>
        <div className='youGiveBackRow'>
      ...
      <div className='youGiveBackInfo'>
        ...
        <div className='youGiveBackColumn'>
          ...
          <div className='infoDiv'>
            <div className='infoDivRow'>
              <p className='infoDivRowTitle'>Data </p> <span>{dataForm.dataDeliver}</span>
            </div>
            <div className='infoDivRow'>
              <p className='infoDivRowTitle'>Godzina </p> <span>{dataForm.pickupTime}</span>
            </div>
            <div className='infoDivRow'>
              <p className='infoDivRowTitle'>Uwagi dla kuriera </p> <span>{dataForm.noteToTheCourier}</span>
            </div>
          </div>
        </div>
      </div>
