  ...
  return (
    <div className='formStepOne'>
      ...
      <div className='rowEnd'>
        <label className='inputName inputNameList'> Liczba 60l worków: <div onMouseLeave={()=>{}} onClick={() => { listFormStepHandle() }} className='listFormStep'><p className='listFormStepTitle'>{inputName}</p> {arrowRotare !== true ? <div className='arrow' /> : <div className='arrow arrowRotare' />} </div></label>
