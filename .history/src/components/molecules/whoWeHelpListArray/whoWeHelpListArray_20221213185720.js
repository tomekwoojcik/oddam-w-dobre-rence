...
const WhoWeHelpListArray = () => {
  ...
  const displayItems = database.slice(pagesVisited, pagesVisited + itemsPerPages).map(el => <WhoWeHelpListItem key={el.id} name={el.organizationName} organizationGoal={el.GoalAndMission} items={el.stuff} />)
