...
const WhoWeHelpListArray = () => {
  ...
  return (
    <ul className='whoWeHelpListArray'>
      ...
      <ReactPaginate className='divPag' previousLabel={'Prev'} nextLabel={'Next'} pageCount={2} onPageChange={changePage} containerClassName ={'paginationBtn'} previousLinkClassName={'prevBtn'} nextLinkClassName = {'nextBtn'} />
    </ul>
  )
}
