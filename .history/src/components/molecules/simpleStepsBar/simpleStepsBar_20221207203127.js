...
const SimpleStepsBar = () => {
  return (
        <div className='simpleStepsBar'>
            <SimpleStepsColumn source={IconOne} simpleStepsColumnTitle={'Wybierz rzeczy'} simpleStepsColumnText={''} />
          <SimpleStepsColumn source={IconSec} simpleStepsColumnTitle={'Spakuj je'} simpleStepsColumnText={''} />
          <SimpleStepsColumn source={IconThr} simpleStepsColumnTitle={'Zdecyduj komu chcesz pomóc'} simpleStepsColumnText={''} />
