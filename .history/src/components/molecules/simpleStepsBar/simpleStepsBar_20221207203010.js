...
const SimpleStepsBar = () => {
    return (
        <div className='simpleStepsBar'>
            <SimpleStepsColumn source={IconOne} simpleStepsColumnTitle={''} />
            <SimpleStepsColumn source={IconSec} simpleStepsColumnTitle={ } />
            <SimpleStepsColumn source={IconThr} simpleStepsColumnTitle={ } />
