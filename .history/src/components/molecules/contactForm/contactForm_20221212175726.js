...
const ContactForm = () => {
  const { setUserName, setUserEmail, setMessage, userEmail, userName, message } = useContext(DatabaseContext)
  return (
    <form className='contactForm'>
      <div className='rowForm'>
        ...
        <InputContactForm handleInput={setUserName} value={userName} type={'email'} labelText={'Wpisz swój email'} placeholderText={'abc@xyz.pl'} />
