...
export function DatabaseProvider ({ children }) {
  ...
  return (
    <DatabaseContext.Provider value={{ database, fetchError, getValue, setUserName, setUserEmail, setMessage, userEmail, userName, message }}>{children}</DatabaseContext.Provider>
  )
}
