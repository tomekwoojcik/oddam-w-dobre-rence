...
export function DatabaseProvider ({ children }) {
  ...
  const pagesCount = Math.ceil(database.lenght / itemsPerPages)
  return (
    <DatabaseContext.Provider value={{ database, fetchError, getValue, setUserName, setUserEmail, setMessage, userEmail, userName, message, sentDataContactUs, inputError, arrayPaginate, pagesVisited, itemsPerPages, pagesCount }}>{children}</DatabaseContext.Provider>
  )
}
