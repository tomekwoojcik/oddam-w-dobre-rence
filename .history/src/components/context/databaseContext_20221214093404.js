...
export function DatabaseProvider ({ children }) {
  ...
  return (
    <DatabaseContext.Provider value={{ database, fetchError, getValue, setUserName, setUserEmail, setMessage, userEmail, userName, message, sentDataContactUs, inputError, arrayPaginate, pagesVisited, itemsPerPages, changePage, email, setEmail, password, setPassword, reapeatPassword, setReapeatPassword }}>{children}</DatabaseContext.Provider>
  )
}
